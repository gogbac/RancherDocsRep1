...
ifdef::BP+iRancher[]
TIP: When {pn_K3s} is imported and combined with {pn_Rancher}, organization’s are equipped with an easy, complete and reliable management solution for Kubernetes at the edge.
endif::BP+iRancher[]
ifdef::BP+iLonghorn[]
...
ifdef::IHV-Supermicro-SuperServer[include::../IHV/Supermicro/SuperServer/SA-RA-BPBV.adoc[]]
endif::iIHV[]
//ifdef::iCSP[]
//FixMe
//endif::iCSP[]
