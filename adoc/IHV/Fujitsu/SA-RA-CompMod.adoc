...
WARNING: Watch out for Bill Da Cat in the Fujitsu CompMod document...
...
NOTE: {an_Fujitsu} https://techlibrary.hpe.com/us/en/enterprise/servers/supportmatrix/suse_linux.aspx[Servers Support & OS Certification Matrices] outlines the minimum version of SLE required for installation, yet later service pack releases may also be used.

include::../../{companyName}/YES.adoc[]

WARING:  Table should be replaced here...

////
//   Commented out this table
