...
* Add the {pn_Rancher} Helm repository: `helm repo add rancher-stable https://releases.rancher.com/server-charts/stable`
* Update the local Helm chart repository information: `helm repo update` 
* Create the cattle-system namespace: `kubectl create namespace cattle-system`
