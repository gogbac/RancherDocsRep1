...
+
NOTE: This hostname should be resolvable to an IP address of the {K8s_name} host, or a load balancer/proxy server that supports this installation of {pn_Rancher}.
+
